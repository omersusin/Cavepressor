...
val CaveTertiary = Color(0xFF8BC34A)
...
val CaveBackground = Color(0xFF0F0B08)
val CaveOnBackground = Color(0xFFEDE0D4)
val CaveSurface = Color(0xFF1A1410)
...
// ── Theme Seeds ───────────────────────────────────────────────────
val ThemeCrimson = Color(0xFFDC143C)
val ThemeViolet = Color(0xFF7C3AED)
val ThemeOcean = Color(0xFF0EA5E9)
val ThemeSage = Color(0xFF16A34A)
val ThemeAmber = Color(0xFFD97706)
val ThemeRose = Color(0xFFEC4899)
val ThemeMono = Color(0xFF6B7280)
val ThemeCave = Color(0xFFD4A843)
val ThemeCustom = Color(0xFFFFFFFF)
